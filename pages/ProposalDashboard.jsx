...
export default function ProposalDashboard() {
  ...
  const sendProposalMutation = useMutation({
    mutationFn: async ({ id, data, proposal }) => {
      const updatedProposal = await apiClient.update('Proposal', id, { 
        ...data, 
        status: 'sent',
        ...
        for (const email of data.recipient_emails) {
          try {
            ...
            if (prospects && prospects.length > 0) {
              await apiClient.update('Prospect', prospects[0].id, {
        ...
        <div className="py-6 lg:py-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-600">Manage, track, and send all client proposals</p>
            </div>
            ...
            {editingProposal && (
              <div className="mb-8">
                ...
                <AIProposalEditor
                  ...
                  proposalCategory={editingProposal?.fields_data?.category || "General"}
                />
              </div>
            )}
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      ...
                      <Button
                        ...
                        className={statusFilter === "sent" ? "bg-blue-600" : ""}
                      >
                        Sent
                      </Button>
                      <Button
                        ...
                        className={statusFilter === "viewed" ? "bg-blue-600" : ""}
                      >
                        Viewed
                      </Button>
                      <Button
                        ...
                        className={statusFilter === "signed" ? "bg-blue-600" : ""}
                      >
                        Signed
                      </Button>
                      <Button
                        ...
                        className={statusFilter === "draft" ? "bg-blue-600" : ""}
                      >
                        Drafts
                      </Button>
                    </div>
                          ...
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                {getProjectName(proposal.project_id)} • {proposal.proposal_number}
                              </p>
                            </div>
                          ...
                          <div className="grid md:grid-cols-4 gap-4 text-sm">
                            ...
                            {proposal.sent_date && (
                              <div className="flex items-center gap-2 text-gray-600">
                                ...
                                <span>Sent {format(new Date(proposal.sent_date), 'MMM d, yyyy')}</span>
                              </div>
                            )}
                            {proposal.signed_date && (
                              <div className="flex items-center gap-2 text-gray-600">
                                <CheckCircle className="w-4 h-4 text-green-600" />
                                <span>Signed {format(new Date(proposal.signed_date), 'MMM d, yyyy')}</span>
                              </div>
                            )}
                  ...
                  <div className="space-y-3">
                    {proposals.filter(p => proposalProjectFilter === "all" || p.project_id === proposalProjectFilter).length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Visit Contacts → Form Submissions to generate AI proposals</p>
                      </div>
                    ) : (
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1 cursor-pointer" onClick={() => setEditingProposal(proposal)}>
                              ...
                              <div className="flex items-center gap-2 text-xs text-gray-500">
                                ...
                                {proposal.sent_date && (
                                  <span>• Sent {format(new Date(proposal.sent_date), 'MMM d')}</span>
                                )}
                              </div>
                            </div>
